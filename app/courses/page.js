...
export default function CoursesPage() {
  ...
  const modules = [
    'Weekly live cohort sessions + full pre-recorded library',
    ...
    'AI Essentials + 2 AI Certifications Guidance',
    'Portfolio Capstone Project',
    'Coach Feedback & Private Community',
  ];
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-6 py-24 md:py-32">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 bg-gradient-to-r from-gold-300 via-gold-500 to-gold-300 bg-clip-text text-transparent">
            Become a Product Owner in 12 Weeks
          </h1>
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            Our 12-week VIP program combines live coaching with a full pre-recorded curriculum
            to transform you into a job-ready, certified Product Owner.
          </p>
      ...
      <section ref={courseRef} className="relative py-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-400 mb-16 text-center max-w-3xl mx-auto">
            Our comprehensive program includes CSPO certification and prepares you for Product Owner roles. Live coaching combined with a full pre-recorded curriculum.
          </p>
          ...
          <div className="relative backdrop-blur-xl bg-gradient-to-br from-gold-500/20 to-gold-600/10 border-4 border-gold-500/70 rounded-3xl p-8 md:p-10 shadow-2xl">
            ...
            <div className="mt-4">
              ...
              <div className="mb-8">
                <h4 className="text-lg font-bold mb-4 text-gold-300 text-center">What's Included:</h4>
                <div ref={modulesRef} className="space-y-3">
                  {modules.map((module, idx) => (
                    <div key={idx} className="module-item flex items-start gap-3 bg-gold-500/10 p-3 rounded-xl border border-gold-500/20">
      ...
      <section className="relative py-24 px-6 bg-gradient-to-b from-black via-gold-950/5 to-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
            Join 500+ graduates who landed Product Owner roles and transformed their careers.
          </p>
